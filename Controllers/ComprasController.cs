...
namespace App_BodyCorp.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompraId,DataCompra,ClienteId,ValorTotal")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompraId,DataCompra,ClienteId,ValorTotal")] Compra compra)
        {
